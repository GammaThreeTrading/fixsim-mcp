...
public sealed class ReadTools
{
    ...
    [McpServerTool(Name = "fixsim_list_instances", Title = "List FIXSIM instances", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_list_sessions", Title = "List FIX sessions", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_get_session", Title = "Get FIX session", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_list_orders_in", Title = "List inbound orders", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_get_order_in", Title = "Get inbound order", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_list_executions_out", Title = "List outbound execution reports", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_list_executions_in", Title = "List inbound execution reports", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_list_orders_out", Title = "List outbound orders", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "fixsim_list_securities", Title = "List securities", ReadOnly = true, Idempotent = true),
