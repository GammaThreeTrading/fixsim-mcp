...
public sealed class SandboxTools
{
    ...
    [McpServerTool(Name = "sandbox_create_session", Title = "Create sandbox FIX session", Destructive = false),
    ...
    [McpServerTool(Name = "sandbox_get_session", Title = "Get sandbox session", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "sandbox_get_status", Title = "Check sandbox connection status", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "sandbox_get_messages", Title = "Read sandbox FIX message log", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "sandbox_get_orders", Title = "List sandbox orders", ReadOnly = true, Idempotent = true),
    ...
    [McpServerTool(Name = "sandbox_act_on_order", Title = "Fill, reject, or cancel a sandbox order", Destructive = false),
    ...
    [McpServerTool(Name = "sandbox_set_autofill", Title = "Set sandbox auto-fill", Destructive = false),
    ...
    [McpServerTool(Name = "sandbox_end_session", Title = "End sandbox session", Destructive = true),
